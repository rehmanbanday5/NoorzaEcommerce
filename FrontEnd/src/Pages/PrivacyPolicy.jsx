    ...
    <div className="py-10">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-10">
        <div className="w-full sm:w-1/2">
          <img src={assets.Privacy}alt="Privacy Policy"className="w-full h-auto sm:h-[32rem] object-contain sm:object-cover sm:object-center object-left rounded-lg shadow-md">
          </img>
        </div>
