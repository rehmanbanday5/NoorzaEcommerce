  ...
  return (
    <div>
      <div className='text-2xl text-center pt-8 border-t'>
        ...
        <p className=' sm:flex flex-col'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et iure facere molestias aut, mollitia ea praesentium dignissimos commodi cumque recusandae eaque numquam quam architecto accusantium sequi aperiam debitis doloremque blanditiis.</p>
